...
function drawSection(
    ...
    lines.forEach((line, i) => {
        drawRow(doc, y, d.rowH, [
            ...
            { x: x + colConcept,              w: colFormula, text: title === "Bonificaciones" ? "" : line.formula.replace(/\bUSD\b/g, "").replace(/\s{2,}/g, " ").trim(), align: "left",  size: d.fontFormula, mono: true, color: COLORS.muted },
