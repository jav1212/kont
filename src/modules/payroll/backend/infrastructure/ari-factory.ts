...
//
// DI factory — arma el grafo de dependencias de las declaraciones AR-I.
// Invariante: siempre usa ServerSupabaseSource para ejecución del lado servidor.
...
export function getAriActions(userId: string) {
    ...
    const repo   = new RpcAriDeclarationRepository(source, userId);
