    ...
    return (
        <Select
            ...
            classNames={{
                ...
                trigger: [
                    S.trigger,
                    "bg-surface-1 !border !border-solid !border-[var(--control-border)] rounded-lg",
                ...
                popoverContent: [
                    "bg-surface-1 border border-[var(--control-border)] rounded-lg overflow-hidden shadow-[0_12px_28px_rgba(0,0,0,.12)]",
                    "z-[9999]",
                ].join(" "),
                listbox: "p-1",
            }}
