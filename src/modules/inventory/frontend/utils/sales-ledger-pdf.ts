// PDF generator: Libro de Salidas (sales / outbound movements ledger).
//
...
export interface SalesLedgerPdfOpts {
    companyName:     string;
    companyRif?:     string;
...
export async function generateSalesLedgerPdf(
    rows: Movement[],
    ...
    doc.save(`libro-salidas_${opts.period}_${company}.pdf`);
}
