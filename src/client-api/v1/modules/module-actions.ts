...
export function createModuleActions() {
  ...
  return {
    ...
    availableOrganizationModules: new ListAvailableOrganizationModules(
      infrastructure.catalog,
      infrastructure.installations,
    ),
    organizationModules: new ListOrganizationModules(
      infrastructure.installations,
    ),
    ...
    activate: new ActivateModule(
      infrastructure.catalog,
      infrastructure.installations,
      infrastructure.entitlements,
    ),
    suspend: new SuspendModule(
      infrastructure.catalog,
      infrastructure.installations,
    ),
  };
