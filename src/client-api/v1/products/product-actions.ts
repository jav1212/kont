...
export function createProductActions() {
  ...
  return {
    ...
    activate: new SetProductStatus(repository, ProductStatus.Active),
    deactivate: new SetProductStatus(repository, ProductStatus.Inactive),
    movements: new ListProductMovements(repository),
    listCategories: new ListProductCategories(repository),
    getCategory: new GetProductCategory(repository),
    categoryOverview: new ListProductCategoryOverview(repository),
    createCategory: new CreateProductCategory(repository),
    updateCategory: new UpdateProductCategory(repository),
    activateCategory: new SetProductCategoryStatus(
      repository,
      ProductCategoryStatus.Active,
    ),
    deactivateCategory: new SetProductCategoryStatus(
      repository,
