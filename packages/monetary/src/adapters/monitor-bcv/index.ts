import { ExchangeRateApplicationFailure, type CurrencyCatalog, type ExchangeRateProvider, type ExchangeRateSet } from "../../application";
import { currencyCode, exchangeRate, type CurrencyDefinition, type ExchangeRateSnapshot } from "../../domain";
