...
import { ColorScheme, PreferencesFailure, type UserPreferences } from "../../src/domain";
import { GetEffectiveUserPreferences, UpdateUserPreferences, type PreferencesClock, type UserPreferencesRepository } from "../../src/application";
