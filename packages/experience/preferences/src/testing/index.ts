import type { PreferencesClock, UserPreferencesRepository } from "../application";
import { PreferencesFailure, defaultUserPreferences, type UserPreferences } from "../domain";
