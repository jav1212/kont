...
export const organizationRowSchema = z.object({ id: z.uuid(), legacy_tenant_id: z.uuid().nullable(), name: z.string().min(1), slug: z.string().min(1), status: z.enum(OrganizationStatus) });
