import assert from "node:assert/strict";import test from "node:test";import {Currency,money} from "@kontave/billing/domain";import {organizationId} from "@kontave/organizations/domain";import {assertDistinctOrganizations,calculatePercentageReward} from "../../src/domain";
