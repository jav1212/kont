...
/**
 * Validates and normalizes the legally relevant identity captured on a fiscal document.
 *
 * @param input - Party identity as it existed when the fiscal operation occurred.
 * @returns An immutable, normalized party snapshot.
 * @throws {@link FiscalFailure} When a required identity field is empty or exceeds its limit.
 */
