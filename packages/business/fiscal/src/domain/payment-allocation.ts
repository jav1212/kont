...
/**
 * Validates a payment allocation and its optional currency-conversion evidence.
 *
 * @param input - Tendered and recognized amounts assigned to the fiscal document.
 * @returns A normalized payment allocation snapshot.
 * @throws {@link FiscalFailure} When amounts, currencies, or exchange-rate direction are inconsistent.
 */
