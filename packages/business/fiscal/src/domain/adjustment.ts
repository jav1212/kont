...
/**
 * Validates and normalizes an immutable adjustment snapshot for a fiscal document.
 *
 * @param input - Adjustment values captured by the owning fiscal operation.
 * @returns A normalized adjustment snapshot suitable for document reconciliation.
 * @throws {@link FiscalFailure} When the amount or percentage is not positive.
 */
