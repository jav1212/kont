...
import { SALES_COMPANY_ID, SALES_CUSTOMER_ID, SALES_ORDER_LINE_ID, SALES_VES, customerFixture } from "../../src/testing";
import { ConfirmCustomerInvoiceMatch, type SalesCommitPort } from "../../src/application";
