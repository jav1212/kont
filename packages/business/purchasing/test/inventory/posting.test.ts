...
import { goodsReceiptId, goodsReceiptLineId, purchaseDate, purchaseInstant, purchaseQuantity, purchaseReturnId, purchaseReturnLineId, supplierId, type PurchaseReceiptConfirmed, type PurchaseReturnConfirmed } from "../../src/domain";
import { purchaseReceiptInventoryPosting, purchaseReturnInventoryOperation, reversePurchaseReceiptInventoryOperation } from "../../src/adapters/inventory";
