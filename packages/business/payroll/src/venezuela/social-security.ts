...
/**
 * Assesses worker and employer IVSS contributions from exact weekly bases.
 * @param input - Monthly income, minimum wage, contributable weeks, employer risk, and rule date.
 * @returns Exact weekly base and quantified worker/employer contributions.
 * @throws {VenezuelanPayrollFailure} When money, weeks, risk, or rule inputs are invalid.
 */
...
/**
 * Assesses monthly RPE contributions using the prior month's normal salary and legal bounds.
 * @param input - Prior salary, minimum wage, part-time fraction, suspension state, and rule date.
 * @returns Exact contribution base with employee and employer amounts.
 * @throws {VenezuelanPayrollFailure} When fractions, money, or rule inputs are invalid.
 */
...
/**
 * Reconciles an RPE assessment against amounts already applied for the legal month.
 * @param input - Current RPE assessment, prior worker/employer applications, and period key.
 * @returns Separate reconciled worker and employer obligations.
 * @throws {VenezuelanPayrollFailure} When currencies, amounts, or period keys are invalid.
 */
