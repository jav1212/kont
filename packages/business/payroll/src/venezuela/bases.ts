...
/**
 * Derives Venezuelan statutory base membership from an earning's legal nature.
 * @param input - Explicit earning classification and tax treatment.
 * @returns Membership flags for each supported statutory base.
 */
