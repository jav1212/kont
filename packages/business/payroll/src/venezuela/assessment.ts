...
/**
 * Reconciles a cumulative Venezuelan obligation against amounts already applied.
 * @param input - Stable obligation key, assessed total, prior application, and legal rule.
 * @returns The current application and outstanding balance without producing negative amounts.
 * @throws {VenezuelanPayrollFailure} When keys, amounts, or currencies are invalid.
 */
