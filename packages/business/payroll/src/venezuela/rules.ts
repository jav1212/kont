...
/**
 * Resolves the statutory rule version effective for an obligation and local date.
 * @param code - Stable Venezuelan obligation code.
 * @param date - ISO local date of assessment.
 * @returns The effective immutable rule version.
 * @throws {VenezuelanPayrollFailure} When the date is invalid or no effective version exists.
 */
...
/**
 * Converts a statutory rule into the jurisdiction-neutral payroll audit reference.
 * @param rule - Effective Venezuelan statutory rule.
 * @returns A portable policy reference retained by payroll results.
 */
