...
/**
 * Calculates the annual AR-I withholding percentage from declared or employer-estimated data.
 * @param input - Annual remuneration, tax unit, deductions, rebates, dependants, and omission policy.
 * @returns Exact annual tax, taxable income, and withholding percentage.
 * @throws {VenezuelanPayrollFailure} When amounts, alternatives, or tax-unit inputs are invalid.
 */
...
/**
 * Applies an AR-I percentage to one taxable payment.
 * @param taxablePayment - Non-negative taxable payment.
 * @param percentage - Exact non-negative withholding percentage.
 * @returns Exact withholding in the payment currency.
 * @throws {VenezuelanPayrollFailure} When the payment or percentage is negative.
 */
...
/**
 * Applies Venezuelan natural-person Tariff No. 1 to net income expressed in tax units.
 * @param netIncomeUt - Non-negative net annual income in tax units.
 * @returns Exact annual tax in tax units.
 * @throws {VenezuelanPayrollFailure} When income is negative.
 */
