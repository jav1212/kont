...
/**
 * Validates a balance definition and its dimensional/currency invariants.
 * @param input - Balance definition to validate.
 * @returns A normalized immutable definition copy.
 * @throws {PayrollFailure} When dimensions are missing or duplicated, or currency conflicts with the unit.
 */
