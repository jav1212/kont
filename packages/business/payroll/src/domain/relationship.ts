...
/**
 * Validates a payroll relationship and orders its non-overlapping compensation history.
 * @param input - Relationship aggregate snapshot.
 * @returns A copy with compensation agreements ordered by effective date.
 * @throws {PayrollFailure} When dates are invalid, inverted, or compensation agreements overlap.
 */
...
/**
 * Ensures an active relationship intersects a payroll period.
 * @param relationship - Relationship to evaluate.
 * @param period - Payroll period being processed.
 * @returns Nothing when the relationship is eligible.
 * @throws {PayrollFailure} When the relationship is inactive or outside the period.
 */
...
/**
 * Resolves the currency carried by any supported compensation basis.
 * @param basis - Compensation basis to inspect.
 * @returns Its immutable currency definition.
 */
