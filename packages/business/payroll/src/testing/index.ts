...
/**
 * Creates a deterministic payroll element entry identifier for tests.
 * @param suffix - Scenario-specific identifier suffix.
 * @returns A branded entry identifier prefixed with `entry-`.
 * @throws {PayrollFailure} When the generated identifier is invalid.
 */
