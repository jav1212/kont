...
export interface AuthenticatedSessionRegistry {
  observe(input: {
    readonly id: AuthenticatedSessionId;
    readonly userId: string;
    readonly client: SessionClientKind;
...
export class ObserveAuthenticatedSession {
  constructor(private readonly registry: AuthenticatedSessionRegistry) {}

  execute(input: Parameters<AuthenticatedSessionRegistry["observe"]>[0]): Promise<void> {
...
export class ChangePassword {
  constructor(
    ...
    private readonly sessions: AuthenticatedSessionRegistry,
  ) {}
