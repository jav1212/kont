...
export type KontaveClientFeatures = {
  ...
  readonly platformStatus: ClientPortFeature<PlatformStatusPort>;
...
export function createKontaveApplicationClient(
  ...
  const platformStatus = createPortFeature<PlatformStatusPort>({
    current: () => options.ports.platformStatus.current(),
  });
  ...
  return createKontaveClient({
    features: Object.freeze({
      ...
      platformStatus: platformStatus.feature,
