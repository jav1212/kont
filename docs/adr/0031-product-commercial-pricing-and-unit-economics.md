...
- `unit-economics` es un read model de aplicación que compone compras y ventas confirmadas. No introduce un dominio ni convierte movimientos de inventario en documentos comerciales.
