...
import { calculateWeeklyFactor } from "@/src/frontend/utils/payroll-helper";
...
export default function PayrollCalculator() {
    ...
    const handleAutoFill = useCallback(() => {
        setEarningRows((prev) => {
            ...
            // Update the first 3 rows (Normales, Sabados, Domingos) quantities
            // Keep all other fields (label, multiplier, useDaily) intact
                ...
                <BaseAccordion.Root selectedKeys={expandedKeys} onSelectionChange={setExpandedKeys}>
                    ...
                    >
                        <div className="space-y-6">
                            ...
                            {/* Rest of params (exchange rate + salary) */}
                            <ParamsSection
