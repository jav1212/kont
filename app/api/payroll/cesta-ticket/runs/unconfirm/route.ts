// API route for unconfirming a cesta ticket run — reverts it to 'draft'.
// No accounting integration is generated for cesta ticket, so this is a pure
// state change. Interface adapter only.
