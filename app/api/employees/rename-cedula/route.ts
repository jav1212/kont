...
export const POST = withTenantPermission("employees.update", async (req, { userId, actingAs, effectiveOwnerId, tenantId}) => {
    try {
        ...
        const result  = await getEmployeeActions(tenantId).renameEmployeeCedula.execute({
