                            ...
                            return (
                                <div key={idx} className="grid grid-cols-[1fr_120px_160px_90px_160px_36px] gap-2 px-4 py-2 items-center">
                                    ...
                                    <BaseInput.Field
                                        ...
                                        onValueChange={(v) => updateItem(idx, { cantidad: Number(v) || 0 })}
                                        placeholder="0"
                                        min={0.0001}
                                        step={0.0001}
                                    />
                                    ...
                                    <BaseInput.Field
                                        ...
                                        value={item.costoMoneda ? String(item.costoMoneda) : ""}
                                        onValueChange={(v) => updateItem(idx, { costoMoneda: Number(v) || 0 })}
                                        placeholder="0.00"
                                        min={0}
                                        step={0.01}
                                        suffix={item.moneda === "D" ? "USD" : "Bs"}
                                    />
