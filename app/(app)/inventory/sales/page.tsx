                            ...
                            {filtered.map((m) => {
                                ...
                                return (
                                    <BaseListCard
                                        ...
                                        badge={<TypeBadge type={m.type as OutboundKind} />}
                                        rows={[
                                            { label: "Cantidad", value: fmtN0(m.quantity), align: "right", numeric: true },
                                            ...(unit != null
                                                ? [{ label: "Precio unit.", value: fmtN(unit), align: "right" as const, numeric: true }]
                                                : []),
                                            ...(totalVenta != null
                                                ? [{
                                                    label: "Total venta",
                                                    value: <span className="font-bold">Bs. {fmtN(totalVenta)}</span>,
                                                    align: "right" as const,
                                                    numeric: true,
                                                }]
                                                : []),
                                            { label: "Costo", value: fmtN(m.totalCost), align: "right", numeric: true },
                                            ...(m.reference
