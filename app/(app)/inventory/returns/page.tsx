...
export default function DevolucionesPage() {
    return (
        <div className="min-h-full bg-surface-2 font-mono">
            <PageHeader title="Devoluciones de Inventario" subtitle="Devoluciones a proveedores y de clientes">
                <BaseButton.Root as={Link} href="/inventory/returns/new" variant="primary" size="sm">
                    + Nueva devolución
                </BaseButton.Root>
            </PageHeader>
