...
export default function PayrollCalculator() {
    ...
    const diasNocturnosQuincena = useMemo(() => {
        ...
        return isNaN(parsed) || diasNocturnosInput === "" ? activePeriodInfo.weekdays : Math.max(0, parsed);
    }, [diasNocturnosInput, activePeriodInfo.weekdays]);
                                    ...
                                    {bonoNocturnoEnabled && (
                                        <div>
                                            ...
                                            <input
                                                ...
                                                min="0"
                                                step="1"
                                                placeholder={String(activePeriodInfo.weekdays)}
                                            ...
                                            <p className="font-mono text-[12px] text-[var(--text-tertiary)] mt-1.5">
                                                Vacío = todos los días normales ({activePeriodInfo.weekdays}d)
                                            </p>
