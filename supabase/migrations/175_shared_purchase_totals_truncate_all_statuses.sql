-- Apply precise fiscal totals to itemized drafts and confirmed invoices.
-- Credit notes keep the negative sign in the invoice header.
...
begin
    ...
    set subtotal = v_sign * trunc(v_subtotal_raw, 2),
