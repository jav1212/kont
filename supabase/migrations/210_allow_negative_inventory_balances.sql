-- Inventory can legitimately be negative when migrating legacy balances or
-- recording sales before their corresponding purchase is entered.
-- Keep the quantity positive and let outbound movements produce a signed balance.
