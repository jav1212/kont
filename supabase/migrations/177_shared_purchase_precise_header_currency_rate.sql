-- Use the invoice BCV rate with all available decimals for USD lines.
-- Some legacy lines stored a two-decimal line rate even when the invoice
-- header retained four decimals, which could move the fiscal base by 0.01.
