...
-- Corrige los argumentos del format() en tenant_inventario_reporte_periodo.
-- La migración 041 tenía 2 v_schema de más en el bloque del query principal,
-- haciendo que WHERE p.empresa_id = %L recibiera el nombre del schema en vez
-- del ID de la empresa → ningún producto hacía match → resultados vacíos.
-- =============================================================================
