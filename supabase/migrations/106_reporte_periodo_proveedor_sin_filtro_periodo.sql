-- =============================================================================
-- 106_reporte_periodo_proveedor_sin_filtro_periodo.sql
--
-- Fix: el CTE `proveedor_por_producto` en tenant_inventario_reporte_periodo
-- filtraba por `fc.periodo = p_periodo`, ocultando el proveedor de cualquier
-- producto cuya última factura confirmada fuera de un período anterior al
-- consultado. Quitamos ese filtro: con DISTINCT ON (producto_id) +
-- ORDER BY fc.fecha DESC tomamos siempre la última factura confirmada del
-- producto en cualquier período.
-- =============================================================================
